...
paciente(p1, 35, 36, 90, 15, 120, 100, false, 0). % sem risco (verde)
paciente(p2, 75, 39, 110, 30, 120, 100, false, 1). % 14 dias de observação (amarelo)
paciente(p3, 65, 37.5, 105, 20, 120, 100, false, 1). % 14 dias de observação (amarelo)
paciente(p4, 22, 36, 100, 25, 90, 95, true, 0). % p_arterial e dispinéia (laranja)
paciente(p5, 21, 36, 150, 35, 110, 100, true, 0). % freq_res e dispinéia (vermelho)
...
medio(X):- idade(X), temperatura(X), cardiaca(X), respiratoria(X), comorbidade(X),
    print(X), write(" Paciente de baixo risco\n").
